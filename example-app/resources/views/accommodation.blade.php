<x-inside-layout :sections="[
    ...
    <br>
        ...
        <span class="font-medium text-base">Except for these places, <b>we highly recommend you check out the local Facebook groups</b> for great deals on second-hand furniture, often for half or even less than the price of new items.
        <br>
