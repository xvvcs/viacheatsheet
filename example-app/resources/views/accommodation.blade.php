<x-inside-layout :sections="[
        ...
        <div class="mb-3">
            ...
            <ol class="relative border-s border-gray-700 dark:border-gray-700">
                <li class="mb-6 ms-4">
                    ...
                    <time class="mb-1 text-sm font-bold leading-none text-gray-500 dark:text-gray-500">Cheap</time>
                    ...
                    <a href="https://kamtjatka.dk/" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-300 bg-gray-800 border border-gray-600 rounded-lg hover:bg-gray-700 hover:text-blue-500 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-100 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">Check it here <svg class="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                        </svg></a>
                </li>
                <li class="mb-10 ms-4">
                    <div class="absolute w-3 h-3 bg-gray-700 rounded-full mt-1.5 -start-1.5 border border-gray-900 dark:border-gray-900 dark:bg-gray-700"></div>
                    <time class="mb-1 text-sm font-bold leading-none text-gray-500 dark:text-gray-500">Normal</time>
                    ...
                    <a href="social#fb" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-300 bg-gray-800 border border-gray-600 rounded-lg hover:bg-gray-700 hover:text-blue-500 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-100 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">Check facebook groups <svg class="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                        </svg></a>
                </li>
                <li class="mb-10 ms-4">
                    <div class="absolute w-3 h-3 bg-gray-700 rounded-full mt-1.5 -start-1.5 border border-gray-900 dark:border-gray-900 dark:bg-gray-700"></div>
                    <time class="mb-1 text-sm font-bold leading-none text-gray-500 dark:text-gray-500">Expensive</time>
                    ...
                    <a href="https://horsensstudieboliger.dk/" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-300 bg-gray-800 border border-gray-600 rounded-lg hover:bg-gray-700 hover:text-blue-500 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-100 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">Check it here <svg class="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                        </svg></a>
                </li>
                <li class="ms-4">
    ...
    <br>
        ...
        <svg class="flex-shrink-0 inline w-5 h-5 mr-3 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l6.518 11.59c.75 1.336-.213 3.011-1.742 3.011H3.481c-1.53 0-2.492-1.675-1.742-3.011l6.518-11.59zM11 14a1 1 0 10-2 0 1 1 0 002 0zm-1-2a1 1 0 01-1-1V8a1 1 0 112 0v3a1 1 0 01-1 1z" clip-rule="evenodd"></path>
                ...
                <span class="font-medium text-base">Except for these places, <b>we highly recommend you check out the local Facebook groups,</b> <span class="font-bold text-blue-500 underline dark:text-black decoration-indigo-500">and the G.O.A.T - Facebook marketplace,</span> for great deals on second-hand furniture, often for half or even less than the price of new items.
        <br>
        Think of it as eBay, but for Denmark. Check out our <a href="/social#fb" class="font-medium text-blue-600 underline dark:text-blue-500 dark:hover:text-blue-600 hover:text-blue-700 hover:no-underline">section about Facebook groups</a> for more information.</span>
    </div>
    ...
    <!-- when moving in -->
    <h2 class="text-2xl font-bold text-neutral-900 dark:text-neutral-900 pb-4">When moving in...</h2>
        <!-- trailers -->
    <h3 class="text-xl font-bold text-neutral-900 dark:text-neutral-900">Trailers</h3>
