...
<figure class="max-w-screen-md mx-auto text-center py-9 mb-5">
...
<footer class="bg-white shadow-sm dark:bg-gray-800">
    <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 Created by <a href="https://github.com/xvvcs" class="hover:underline">Matuszewski</a> & <a href="https://github.com/imskaff" class="hover:underline">Terelak</a>. All rights reserved. This is an independent website and is not affiliated with, sponsored, or endorsed by VIA University College. The VIA University College name is a registered trademark of VIA University College.</span>
