    ...
    <div class="bg-neutral-100 rounded-2xl shadow p-6 mb-10 dark:bg-neutral-100" id="feriepenge">
        ...
        <div class="md:flex">
            <ul class="flex-column space-y space-y-4 text-sm font-medium text-gray-400 dark:text-gray-400 md:me-4 mb-4 md:mb-0" id="feriepenge-tabs">
                <li>
                    <a href="#" class="tab-link inline-flex items-center px-4 py-3 rounded-lg hover:text-white bg-gray-800 hover:bg-gray-700 w-full dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white" data-tab="where-to-get" aria-current="page">
                ...
                <li>
                    <a href="#" class="tab-link inline-flex items-center px-4 py-3 rounded-lg hover:text-text-white bg-gray-800 hover:bg-gray-700 w-full dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white" data-tab="how-to-claim">
                ...
                <li>
                    <a href="#" class="tab-link inline-flex items-center px-4 py-3 rounded-lg hover:text-text-white bg-gray-800 hover:bg-gray-700 w-full dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white" data-tab="how-much">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-7 pr-2">
                ...
                <li>
                    <a href="#" class="tab-link inline-flex items-center px-4 py-3 rounded-lg hover:text-text-white bg-gray-800 hover:bg-gray-700 w-full dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white" data-tab="be-aware">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-7 pr-2">
