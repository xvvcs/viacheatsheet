<x-inside-layout :sections="[
    ...
    <div class="bg-white rounded-2xl shadow p-6 mb-10 dark:bg-neutral-100" id="feriepenge">
        <h3 class="text-2xl font-bold mb-3 text-neutral-800 dark:text-neutral-900">How does <mark class="px-2 text-white bg-blue-600 rounded-sm dark:bg-violet-500">feriepenge</mark> work?</h3>
        <p class="text-gray-600 dark:text-neutral-700 leading-relaxed pb-8">It's real deal and lifesaver for your abroad holiday trips. Feriepenge is a holiday pay that you earn while working. It is usually around 12.5% of your gross salary and it is paid out when you take a holiday.</p>
        <hr class="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700">


        <div class="md:flex">
            <ul class="flex-column space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0" id="feriepenge-tabs">
                <li>
                    <a href="#" class="tab-link inline-flex items-center px-4 py-3 text-white bg-blue-700 rounded-lg active w-full dark:bg-blue-600" data-tab="where-to-get" aria-current="page">
                ...
                <li>
                    <a href="#" class="tab-link inline-flex items-center px-4 py-3 rounded-lg hover:text-gray-900 bg-gray-50 hover:bg-gray-100 w-full dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white" data-tab="how-to-claim">
                ...
                <li>
                    <a href="#" class="tab-link inline-flex items-center px-4 py-3 rounded-lg hover:text-gray-900 bg-gray-50 hover:bg-gray-100 w-full dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white" data-tab="how-much">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-7 pr-2">
                ...
                <li>
                    <a href="#" class="tab-link inline-flex items-center px-4 py-3 rounded-lg hover:text-gray-900 bg-gray-50 hover:bg-gray-100 w-full dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white" data-tab="be-aware">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-7 pr-2">
            ...
            <div class="tab-content-container w-full">
                <!-- Where to get feriepenge -->
                <div id="where-to-get" class="tab-content p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Where to get feriepenge?</h3>
                    <p class="mb-4 text-gray-700 dark:text-gray-300">Feriepenge is automatically collected through your employer and managed by the Feriekonto system.</p>

                    <h4 class="font-semibold text-gray-900 dark:text-white mb-2">Main sources:</h4>
                ...
                <div id="how-to-claim" class="tab-content p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full hidden">
                    ...
                    <div class="mt-4 p-3 bg-green-100 dark:bg-green-900 rounded-lg">
                        <p class="text-sm text-green-800 dark:text-green-200"><strong>Additional info:</strong> As far as I know, you can pay it out whenever, just be sure you will or had a holiday some time ago.</p>
                    </div>
                </div>

                <!-- How much will I get -->
                <div id="how-much" class="tab-content p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full hidden">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">How much feriepenge will I get?</h3>
                    <p class="mb-4 text-gray-700 dark:text-gray-300">Your feriepenge is calculated as 12.5% of your gross annual salary. Therefore, it depends on you and your salary how much you will get. Tho, I can give some examples.</p>

                    <h4 class="font-semibold text-gray-900 dark:text-white mb-2">Calculation examples:</h4>
                    <div class="space-y-3">
                        <div class="p-3 bg-white dark:bg-gray-700 rounded border">
                            <p class="font-medium text-gray-900 dark:text-white">Random monthly salary: 20,000 DKK</p>
                            <p class="text-gray-700 dark:text-gray-300">Annual: 240,000 DKK × 12.5% = <strong>30,000 DKK feriepenge</strong></p>
                        </div>
                        <div class="p-3 bg-white dark:bg-gray-700 rounded border">
                            <p class="font-medium text-gray-900 dark:text-white">Approx. REMA 1000 salary: 15,000 DKK</p>
                            <p class="text-gray-700 dark:text-gray-300">Annual: 180,000 DKK × 12.5% = <strong>22,500 DKK feriepenge</strong></p>
                        </div>
                    </div>

                    <h4 class="font-semibold text-gray-900 dark:text-white mb-2 mt-4">What affects the amount:</h4>
                    ...
                    <div class="mt-4 p-3 bg-yellow-100 dark:bg-yellow-900 rounded-lg">
                        <p class="text-sm text-yellow-800 dark:text-yellow-200"><strong>Note:</strong> Feriepenge is paid out gross, so taxes will be deducted when you receive it. All feriepenge you see on the website is BEFORE tax, so account that.</p>
                    </div>
                </div>

                <!-- What to be aware of -->
                <div id="be-aware" class="tab-content p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full hidden">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">What to be aware of?</h3>
                    <p class="mb-4 text-gray-700 dark:text-gray-300">There are important rules and limitations you should know about feriepenge.</p>

                    <h4 class="font-semibold text-red-600 dark:text-red-400 mb-2">⚠️ Important limitations:</h4>
                    ...
                    <div class="mt-4 p-3 bg-red-100 dark:bg-red-900 rounded-lg">
                        <p class="text-sm text-red-800 dark:text-red-200"><strong>Warning:</strong> If you're leaving Denmark permanently, make sure to claim your feriepenge before departure - the process can be complicated from abroad.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            tabLinks.forEach(link => {
                link.addEventListener('click', function(e) {
                    ...
                    tabLinks.forEach(tab => {
                        tab.classList.remove('text-white', 'bg-blue-700', 'dark:bg-blue-600', 'active');
                        tab.classList.add('rounded-lg', 'hover:text-gray-900', 'bg-gray-50', 'hover:bg-gray-100', 'dark:bg-gray-800', 'dark:hover:bg-gray-700', 'dark:hover:text-white');
                        tab.removeAttribute('aria-current');
                    });

                    // Add active classes to clicked tab
                    this.classList.remove('rounded-lg', 'hover:text-gray-900', 'bg-gray-50', 'hover:bg-gray-100', 'dark:bg-gray-800', 'dark:hover:bg-gray-700', 'dark:hover:text-white');
                    this.classList.add('text-white', 'bg-blue-700', 'dark:bg-blue-600', 'active');
